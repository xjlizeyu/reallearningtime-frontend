...
exports.fetchStatistic = exports.newPlan = exports.deletePlan = exports.timing = exports.stopTiming = exports.startTiming = exports.getTime = exports.signIn = exports.logIn = void 0;
...
_axios["default"].defaults.baseURL = "http://time.lenmain.cn";
_axios["default"].defaults.withCredentials = true;
_axios["default"].defaults.headers["Content-Type"] =
  "application/x-www-form-urlencoded"; //声明通过axios与后端通信的api
//-----------------------------------------
//用户信息以及登陆注册相关api
...
var timing = function timing() {
  return _axios["default"].post("/timing/timing");
}; //-----------------------------------------
//-----------------------------------------
//计划相关api
